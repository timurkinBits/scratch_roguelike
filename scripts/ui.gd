...
#func change_scores(type: Command.TypeCommand, value: int, max_points: int) -> void:
	#match type:
		#Command.TypeCommand.MOVE:
			#walk_label.text = str(max_points - value)
		#Command.TypeCommand.ATTACK:
			#attack_label.text = str(max_points - value)
		#Command.TypeCommand.DEFENSE:
			#defense_label.text = str(max_points - value)
		#Command.TypeCommand.HEAL:
			#heal_label.text = str(max_points - value)
